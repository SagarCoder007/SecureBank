    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <div className="mx-auto w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-full flex items-center justify-center mb-4 sm:mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto mb-12 sm:mb-16">
          ...
          <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300 border-0">
            <CardHeader className="text-center pb-4">
              ...
              <CardTitle className="text-xl sm:text-2xl">Customer Banking</CardTitle>
            ...
            <CardContent className="pt-2">
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start space-x-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
          ...
          {/* Banker Login Card */}
          <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300 border-0 bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20">
            <CardHeader className="text-center pb-4">
              ...
              <CardTitle className="text-xl sm:text-2xl text-purple-600 dark:text-purple-400">Banking Portal</CardTitle>
              <CardDescription className="text-sm sm:text-base">
            ...
            <CardContent className="pt-2">
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start space-x-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-purple-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <Button 
                  className="w-full bg-purple-600 hover:bg-purple-700 focus:ring-purple-500 mt-4 sm:mt-6" 
                  size="lg"
                >
        ...
        <div className="text-center px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            <div className="text-center p-4 rounded-2xl bg-white dark:bg-gray-800 shadow-sm">
              <div className="mx-auto w-12 h-12 sm:w-14 sm:h-14 bg-green-100 dark:bg-green-900 rounded-xl flex items-center justify-center mb-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-2">Bank-Grade Security</h3>
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">256-bit encryption, multi-factor authentication, and fraud protection</p>
            </div>
            <div className="text-center p-4 rounded-2xl bg-white dark:bg-gray-800 shadow-sm">
              <div className="mx-auto w-12 h-12 sm:w-14 sm:h-14 bg-blue-100 dark:bg-blue-900 rounded-xl flex items-center justify-center mb-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-2">Lightning Fast</h3>
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Instant transactions, real-time notifications, and seamless user experience</p>
            </div>
            <div className="text-center p-4 rounded-2xl bg-white dark:bg-gray-800 shadow-sm sm:col-span-2 lg:col-span-1">
              <div className="mx-auto w-12 h-12 sm:w-14 sm:h-14 bg-purple-100 dark:bg-purple-900 rounded-xl flex items-center justify-center mb-4">
              ...
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Round-the-clock customer service and comprehensive help resources</p>
            </div>
          </div>
        </div>
      </div>
